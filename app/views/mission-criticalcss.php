...
.mission-statement{ color: rgb(24, 132, 98); font: normal normal normal 2.4375em/normal populairemedium, Helvetica, sans-serif; text-align: center; width: 580px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; line-height: 1.5; }
@media screen and (min-width: 768px){
.mission-statement{ font-size: 3.4375em; }
}
.mission-bg{ position: fixed; top: 5%; left: 0px; z-index: -1; }
@media screen and (max-width: 767px){
.mission-images.grid [class*="col-"]{ width: 48% !important; margin-top: 0.35em !important; margin-right: 1% !important; margin-bottom: 0.35em !important; margin-left: 1% !important; text-align: center; }
}