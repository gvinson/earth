...
@section('content')
	...
	<section id="rwd-wrapper">
		...
		<h2 class="menu-title orange">
			<img src="/img/icon-soup.png" srcset="/img/icon-soup.png 1x, /img/icon-soup@2x.png 2x" alt="Quiche and Soup">
			QUICHE &amp; SOUP
		</h2>
		<div class="grid">
			<div class="col-8">
				<ul class="menu-dishes orange">
					<li>
						<span class="dish">
							Breakfast Tacos
						</span>
